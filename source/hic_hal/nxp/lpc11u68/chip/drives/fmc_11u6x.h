 ...
 */
typedef enum {
	FLASHTIM_1CLK_CPU = 0,		/*!< Flash 访问时钟1(system clock 达到20M) */
	FLASHTIM_2CLK_CPU = 1,		/*!< Flash 访问时钟2(system clock 达到40M) */
	FLASHTIM_3CLK_CPU = 2,		/*!< Flash 访问时钟3(system clock 达到50M) */
} FMC_FLASHTIM_T;
